...
local function setspeedometer ()
  ...
  RailWorks.SetControlValue(
    "ATC_Node", 0, RailWorks.frombool(atc:isalarm()))
  RailWorks.SetControlValue(
    "ACSES_Node", 0, RailWorks.frombool(acses:isalarm()))
end
