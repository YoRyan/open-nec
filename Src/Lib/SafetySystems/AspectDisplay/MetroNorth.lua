...
function P:getaspect ()
  ...
  elseif acsesmode == Acses.mode.approachmed30
      or atccode == Nec.pulsecode.approach then
  ...
  elseif atccode == Nec.pulsecode.cabspeed60
      or atccode == Nec.pulsecode.cabspeed80
      or atccode == Nec.pulsecode.clear100
...
function P:getcivilspeed_mph ()
  ...
  if sigspeed_mph == nil and not self:getacsessound() then
    ...
    if self:getatcsound() then
      ...
      flash = false
    elseif truesigspeed_mph ~= nil and civspeed_mph
